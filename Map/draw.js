...
!function(t, e, i) {
    ...
    L.Draw.Marker = L.Draw.Feature.extend({
        ...
        _onClick: function() {
            this._fireCreatedEvent(),
            //console.log(this._marker.getLatLng()),              /////// tukaj dobiš koordinate postavljenega stolpa
            //coordinates = this._marker.getLatLng(),
            placedCoordinates(this._marker.getLatLng()),
            this.disable(),
            this.options.repeatMode && this.enable()
    ...
    L.Toolbar = L.Class.extend({
        ...
        _createActions: function(t) {
            ...
            for (var l = 0; l < r; l++)
                "enabled"in s[l] && !s[l].enabled || (e = L.DomUtil.create("li", "", a),
